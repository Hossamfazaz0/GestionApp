  ...
  _editProfile() async {
    ...
    if (_genderValue == "") {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Vous devez choisir le sexe"),
        ),
      );
      return;
    }
    ...
    if (selectedSpecialist == "") {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Vous devez choisir Spécialiste"),
        ),
      );
      return;
    }
