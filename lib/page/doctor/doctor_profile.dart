...
class _DoctorProfileState extends State<DoctorProfile> {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                "Nom : ${value.doctor!.name}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.bold),
                              ),
                              const SizedBox(height: 4),
                              Text(
                                "E-mail : ${value.doctor!.email}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.bold),
                              ),
                              const SizedBox(height: 4),
                              Text(
                                " Numéro de téléphone: ${value.doctor!.phoneNumber}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.bold),
                              ),
                              const SizedBox(height: 4),
                              Text(
                                " Adresse: ${value.doctor!.address}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.bold),
  ...
  imgSourceDialog() async {
    return showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text("Prendre une photo de"),
          content: Row(
